...
> 版本：V1.1 | 日期：2026-05-02 | 适配 RT-Thread 版本
...
- MCU 通过 USART2（rt_device uart2）向 ESP-01S 发送 AT 指令配置和数据透传
- RT-Thread 下使用串口设备驱动框架，接收中断触发 sem_wifi_rx 信号量通知 t_wifi 线程处理
